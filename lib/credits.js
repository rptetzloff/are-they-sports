...
export const REFERENCE_CREDITS = [
	{
		...
		// Named and linked, because CC BY-SA asks for both. The two curated
		// files are transcriptions of their tables rather than of facts read
		// somewhere and rewritten, so this is the licence's own request rather
		// than a courtesy — and a licence named without a link is half of it.
		//
		// The version is Wikipedia's current one. Correct it here if that
		// changes; the credit renders whatever this says.
