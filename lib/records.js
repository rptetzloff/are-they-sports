 ...
 *
 *  Three would be right for a single season, where 17 games cannot resolve a
 *  fourth decimal. Nothing renders a season percentage today; when something
 *  does, this takes a digits argument rather than a second function.
 *
 ...
 */
export const pct = (p) => (p >= 1 ? p.toFixed(4) : p.toFixed(4).replace(/^0/, ''));
