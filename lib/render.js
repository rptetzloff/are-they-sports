...
<tbody>${leaders.map(row).join('')}</tbody></table>
	...
	if (switcher) body.push(switcher);
	// Beside the switcher and below the table, which is where the club page puts
	// it: both are things a reader does WITH the page rather than things the
	// page says. It sat above the table first and read as a control.
